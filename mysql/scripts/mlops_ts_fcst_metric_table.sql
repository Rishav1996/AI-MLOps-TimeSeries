...
--
-- Table structure for table `metric_table`
--
...
--
-- Dumping data for table `metric_table`
--

LOCK TABLES `metric_table` WRITE;
/*!40000 ALTER TABLE `metric_table` DISABLE KEYS */;
INSERT INTO `metric_table` VALUES (1,'rmse','performance'),(2,'rmspe','performance'),(3,'aic','performance'),(4,'bic','performance'),(5,'bias','performance'),(6,'mape','performance'),(7,'psi','data_drift'),(8,'ks','data_drift');
/*!40000 ALTER TABLE `metric_table` ENABLE KEYS */;
UNLOCK TABLES;
